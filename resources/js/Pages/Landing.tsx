...
export default function Landing({auth}: PageProps)
{
    ...
    return (
        <GuestLayout>
            ...
            <div className="min-h-screen pb-8 lg:pt-16 lg:px-8 bg-black bg-center bg-cover bg-no-repeat bg-opacity-80" style={bgImg}>
                <div className="grid md:grid-cols-4 py-8 px-4 bg-black bg-opacity-70 md:bg-none md:bg-opacity-0">
                    <div className="flex flex-col pb-8 gap-y-2 md:col-span-2 pb-5">
                        <span className={`h-1 w-16 bg-white`}></span>
                        <h1 className="mt-1 py-2 text-3xl md:text-4xl lg:text-6xl font-extrabold text-red-600">
                            We Ideate, Innovate, & Create <span className="text-slate-50 md:text-3xl lg:text-5xl">Technology Solutions</span>
                        </h1>

                        <p className="mt-4 lg:mt-6 pb-5 text-sm lg:text-base text-slate-300">
                    ...
                    <div className="hidden md:flex md:col-span-2 text-slate-100">
                        <div className="p-3 lg:p-10 lg:py-16 md:grid md:grid-cols-4">
                            ...
                            <div className="md:col-span-2 text-sm md:px-6">
                                <h3 className="py-1.5 col-span-2 font-semibold">
                ...
                <div className="p-4 flex flex-nowrap overflow-x-scroll lg:overflow-x-none gap-x-10 bg-white">
                    <div className={`py-1 mt-2 lg:mt-0 min-w-max`}>
                        <h2 className={`text-xl lg:text-3xl font-bold lg:font-extrabold`}>Top Services</h2>
                        <p className={`py-1 text-sm text-slate-800`}>Top-Tier Digital Solutions</p>
                    </div>

                    <div className={`px-2 lg:px-8 min-w-60`}>
                        <p className={`p-2 px-3 bg-black text-slate-200 font-medium`}>
                            Website Development
                        </p>
                        <p className={`p-3 py-4 -mt-2 ml-3 -mr-3 border border-black text-xs`}>
