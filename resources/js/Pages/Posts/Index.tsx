                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <p className="mt-2 text-lg leading-8 text-gray-600">
                            We are always sharing our knowledge with you. Enjoy
                            and leave a comment.
                        </p>
                    </div>
                        ...
                        {posts.map((post) => (
                            ...
                            >
                                ...
                                <div className="relative mt-8 flex items-center justify-between w-full">
                                    ...
                                    <a
                                        href={post.slug}
                                        className="inline-flex text-sm items-center text-blue-500 hover:underline cursor-pointer hover:text-red-600"
                                    >
                                        Read more
                                        <svg
