...
const ContactBottom = () => {
    return (
        <div className="mt-3 lg:mt-10">
            <div className="flex flex-col md:flex-row md:justify-evenly items-center lg:my-20 ">
                <div>
                    <h1 className="text-xl md:text-3xl lg:text-4xl font-extrabold">
                        Looking to Bring Great <br /> Product to Life?{" "}
                        <span>
                            <p className="text-sm md:text-lg font-normal mt-3">
                ...
                <div className="flex flex-col md:flex-row gap-10 mt-10 mb-5">
                    <img
                        src={profilePic}
                        alt="Dennis Kibet"
