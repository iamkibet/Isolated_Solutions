...
const Footer = () => {
    return (
        <footer className="bg-white text-[#14151b] transition-transform border-t border-[#14151b] pt-6">
            <div className="mx-auto w-full">
                <div className="grid grid-cols-2 gap-8 lg:py-8 md:grid-cols-4 border-b-2 border-black">
                    <div className="col-span-1">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold uppercase text-gray-400">Who we are</h2>
                        ...
                        <div>
                            <h2 className="mt-6 text-sm font-semibold uppercase text-gray-400">Dedicated Hiring</h2>
                           <BorderHover>
                             <a href="/">Looking to hire for long-term or full-time assignments?</a>
                           </BorderHover>
                        </div>
                    </div>
                    <div className="col-span-1">
                    ...
                    <div className="col-span-1">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-400 uppercase">Services</h2>
                            <ul className="text-sm font-medium">
                                <li className="mb-4">
                                    <BorderHover>
                ...
                <div className="py-6 md:flex items-center md:justify-between">
                    <div className="flex flex-col items-center md:flex-row md:items-center md:justify-between w-1/2">
                        <span className="mb-4 text-sm md:text-center md:mb-0 sm:text-center">© 2024 <a href="https://isolatedsolutions.org/">IsolatedSolutions™</a>. All Rights Reserved.</span>
                        <div className="space-x-4 md:flex-col">
                            <BorderHover><a href="#">Terms of Use</a></BorderHover>
                            <BorderHover><a href="#">Privacy Policy</a></BorderHover>
                        </div>
                    </div>
                    <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
                        <BorderHover>
                            <a href="#" className="text-black hover:text-blue-900 hover:scale-125">
                        ...
                        <BorderHover>
                            <a href="#" className="text-black hover:text-blue-900 hover:scale-125">
                                <svg version="1.0" className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488.000000 459.000000" preserveAspectRatio="xMidYMid meet">
