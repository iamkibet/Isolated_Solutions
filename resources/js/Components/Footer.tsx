            ...
            <div className="mx-auto w-full hidden md:block">
                ...
                <div className="py-6 md:flex items-center md:justify-between">
                    <div className="flex flex-col items-center md:flex-row md:items-center md:justify-between w-1/2">
                        <span className="mb-4 text-sm md:text-center md:mb-0 sm:text-center">© {new Date().getFullYear()} <a href="https://isolatedsolutions.tech/">IsolatedSolutions™</a>. All Rights Reserved.</span>
                        <div className="space-x-4 md:flex-col text-black hover:text-gray-400">
                            <BorderHover><a href="#" className="hover:text-black">Terms of Use</a></BorderHover>
                            <BorderHover><a href="#" className="hover:text-black">Privacy Policy</a></BorderHover>
                        </div>
                    </div>
