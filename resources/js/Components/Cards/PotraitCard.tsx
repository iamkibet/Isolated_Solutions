...
const PotraitCard: React.FC<CardWrapProps> = ({
    title,
    content,
    image,
    list,
    ...
    return (
        ...
        >
            <div className="p-4 col-span-2">
                <h3 className="text-2xl box-border text-[#14151b] font-extrabold mb-2">
                    {title}
                </h3>
            ...
            <div className="relative col-span-1 hidden md:block">
                ...
                {isPotrait && (
                    <div
                        ...
                        style={{
                            transform: `translate(${isHovered ? 0 : "90%"}, ${
                                isHovered ? 0 : "-90%"
                            })`, // Slide in from right and top if hovered, otherwise hide off-screen
                    ...
                    >
                        <ul className="max-w-md space-y-1 text-white hover:text-gray-500 w-fit">
                            {list.map((item, index) => (
                                ...
                                >
                                    <span className="group-hover:text-white text-lg mr-2">
                                        ▪{" "}
                                    </span>
                                    {typeof item === "string" ? (
                                        item
                                        ...
                                        >
                                            <a
                                                href={item.link}
                                                className="hover:text-white relative overflow-hidden"
                                            >
                                                {item.text}
                                            </a>
                                        </BorderHover>
