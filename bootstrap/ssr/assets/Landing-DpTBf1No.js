...
import { M as MaxWidthWrapper, N as Navbar, F as Footer } from "./Navbar-CEL9b-rK.js";
...
const SectionHeader$2 = () => /* @__PURE__ */ jsxs("header", { className: "text-center mb-16", children: [
  /* @__PURE__ */ jsxs("h2", { className: "text-4xl md:text-5xl font-bold text-gray-900 mb-6", children: [
    "Reshaping Dynamics of",
    " ",
    /* @__PURE__ */ jsx("span", { className: "block mt-4 text-red-500 font-semibold text-3xl md:text-4xl", children: "Modern~Age Business" }),
    /* @__PURE__ */ jsx("span", { className: "block mt-2 text-red-500 font-semibold text-3xl md:text-4xl", children: "with Our Tech Solutions" })
  ] }),
  /* @__PURE__ */ jsx("div", { className: "w-16 h-1 bg-red-500 mx-auto mb-8", "aria-hidden": "true" }),
...
const ServicesGrid = () => /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-12", children: SERVICES.map((service, index) => /* @__PURE__ */ jsx(
  HoverCard,
  {
    ...service,
...
const SectionHeader$1 = () => /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
  ...
  /* @__PURE__ */ jsx("p", { className: "text-xl text-gray-600 max-w-2xl mx-auto", children: "Your Ideas, Our Expertise = Maximum Customer Success" })
] });
...
const Futech = () => {
  return /* @__PURE__ */ jsx("section", { className: "py-16 md:py-24 border-b border-gray-200", children: /* @__PURE__ */ jsxs(MaxWidthWrapper, { children: [
    /* @__PURE__ */ jsx(SectionHeader$1, {}),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: SOLUTIONS.map((solution, index) => /* @__PURE__ */ jsx(
      SolutionCard,
      {
...
function Landing({ auth }) {
  ...
  return /* @__PURE__ */ jsxs("section", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "w-full bg-white lg:py-8", children: /* @__PURE__ */ jsx(MaxWidthWrapper, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row justify-between", children: [
