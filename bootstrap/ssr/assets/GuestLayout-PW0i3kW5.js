...
import { A as ApplicationLogo } from "./ApplicationLogo-RjVnOy0J.js";
  ...
  return /* @__PURE__ */ jsx("div", { className: "p-4 max-w-3xl grid text-xs font-medium", children: /* @__PURE__ */ jsx(NavCard, { children: /* @__PURE__ */ jsxs("div", { className: "min-w-full flex flex-col gap-y-4 text-black hover:text-slate-400", children: [
    ...
    /* @__PURE__ */ jsx(
      BorderHover,
      {
        defBorderColor: "bg-slate-200",
        hovBorderColor: "bg-black",
        children: /* @__PURE__ */ jsx("a", { href: "#", className: "py-1 hover:text-black", children: "Blog" })
      }
    ),
    /* @__PURE__ */ jsx(
      BorderHover,
...
const MaxWidthWrapper$1 = MaxWidthWrapper;
...
const Footer = () => {
  return /* @__PURE__ */ jsxs("footer", { className: "flex text-[#14151b]  border-t border-[#14151b]", children: [
    /* @__PURE__ */ jsx(MaxWidthWrapper$1, { children: /* @__PURE__ */ jsxs("div", { className: "w-full hidden md:block", children: [
...
function Guest({ children }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col bg-[#f5f5f5] overflow-x-hidden", children: [
    /* @__PURE__ */ jsx(MaxWidthWrapper$1, { className: "", children: /* @__PURE__ */ jsxs("div", { id: "header", className: "top-0 text-[#14151b] py-4", children: [
